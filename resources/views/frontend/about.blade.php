                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="team-thumb">
                                <img src="{{asset('frontend')}}/images/team/matthew-hamilton-tNCH0sKSZbA-unsplash.jpg" class="img-fluid team-image" alt="">
                        ...
                        <div class="col-lg-4 col-12 my-lg-0 my-4">
                            <div class="team-thumb">
                                <img src="{{asset('frontend')}}/images/team/nicolas-horn-MTZTGvDsHFY-unsplash.jpg" class="img-fluid team-image" alt="">
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="team-thumb">
                                <img src="{{asset('frontend')}}/images/team/rc-cf-FMh5o5m5N9E-unsplash.jpg" class="img-fluid team-image" alt="">
            ...
            <section class="newsletter section-padding bg-white">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            <img src="{{asset('frontend')}}/images/charles-deluvio-FdDkfYFHqe4-unsplash.jpg" class="img-fluid newsletter-image" alt="">
                        </div>
